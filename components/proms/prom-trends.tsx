...
export function PromTrends({ patient }: { patient: PatientFullRecord }) {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  ...
                  <XAxis dataKey="milestone" tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                  <YAxis domain={[0, 25]} tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                  <Tooltip
                    contentStyle={{ background: 'hsl(var(--card))', color: 'hsl(var(--card-foreground))', borderRadius: 8, fontSize: 12, fontFamily: 'Plus Jakarta Sans, sans-serif', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
                  />
            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="hsl(var(--border))" />
                  <XAxis dataKey="milestone" tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                  <YAxis domain={[0, 35]} tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                  <Tooltip
                    contentStyle={{ background: 'hsl(var(--card))', color: 'hsl(var(--card-foreground))', borderRadius: 8, fontSize: 12, fontFamily: 'Plus Jakarta Sans, sans-serif', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
                  />
                  <Legend wrapperStyle={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 12 }} />
      ...
      <Card className="shadow-sm border-info/20 dark:border-cyan-900/50">
        <CardHeader className="p-5 pb-2">
          <CardTitle className="text-sm font-bold text-info-muted-foreground dark:text-cyan-200">
          ...
          <div className="h-60 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="hsl(var(--border))" />
                <XAxis dataKey="milestone" tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                <YAxis tickLine={false} tick={{ fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fill: 'hsl(var(--muted-foreground))' }} />
                <Tooltip
                  contentStyle={{ background: 'hsl(var(--card))', color: 'hsl(var(--card-foreground))', borderRadius: 8, fontSize: 12, fontFamily: 'Plus Jakarta Sans, sans-serif', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
                />
                <Area
