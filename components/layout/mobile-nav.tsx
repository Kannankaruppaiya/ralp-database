      ...
      <div className="relative flex w-4/5 max-w-xs flex-1 flex-col bg-card p-6 dark:bg-slate-900">
        <div className="flex items-center justify-between pb-6 border-b">
          ...
          <button
            ...
            className="p-1 text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-md"
          >
            <X className="h-5 w-5" aria-hidden="true" />
          </button>
        </div>
        <nav className="mt-6 space-y-1.5 overflow-y-auto" aria-label="Primary">
