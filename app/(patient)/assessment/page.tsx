  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Post-Operative Outcome Questionnaires</h1>
      ...
      <div className="space-y-4">
        {/* IPSS Card */}
        <Card className="shadow-sm hover:border-teal-500 transition-colors bg-card">
          <CardContent className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/15 text-primary flex-shrink-0">
                <Activity className="h-6 w-6" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-bold text-base text-foreground">International Prostate Symptom Score (IPSS)</h3>
            ...
            <Link href="/assessment/ipss">
              <Button className="gap-1.5 text-xs shadow-sm bg-primary hover:bg-primary/90 text-white">
        ...
        <Card className="shadow-sm hover:border-purple-500 transition-colors bg-card">
          <CardContent className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-bold text-base text-foreground">Sexual Health Inventory for Men (SHIM / IIEF-5)</h3>
        ...
        {/* Incontinence Card */}
        <Card className="shadow-sm hover:border-blue-500 transition-colors bg-card">
          <CardContent className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-bold text-base text-foreground">24-Hour Pad Usage & Continence Log</h3>
