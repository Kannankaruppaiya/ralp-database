        ...
        <Link href="/data-ingestion/upload" className="group">
          <Card className="h-full hover:border-teal-500 transition-colors shadow-sm">
            <CardContent className="p-5 space-y-2">
              ...
              <p className="text-xs text-slate-500">Word (.docx), PDF, or Google Form CSV outputs</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/data-ingestion/extraction-review" className="group">
          <Card className="h-full hover:border-teal-500 transition-colors shadow-sm">
            <CardContent className="p-5 space-y-2">
              ...
              <p className="text-xs text-slate-500">AI field-by-field verification and confidence rating</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/data-ingestion/patient-matching" className="group">
          <Card className="h-full hover:border-teal-500 transition-colors shadow-sm">
            <CardContent className="p-5 space-y-2">
              ...
              <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">3. Patient Matching</h3>
              <p className="text-xs text-slate-500">Match extracted data to NHS number or hospital MRN</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/data-ingestion/conflicts" className="group">
          <Card className="h-full hover:border-teal-500 transition-colors shadow-sm">
            <CardContent className="p-5 space-y-2">
              ...
              <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">4. Conflict Resolver</h3>
              <p className="text-xs text-slate-500">Side-by-side reconciliation of conflicting values</p>
            </CardContent>
          </Card>
        </Link>
      </div>
      ...
      <Card className="shadow-sm">
        <CardHeader className="p-5 pb-3 border-b flex flex-row items-center justify-between space-y-0">
          <div>
            ...
            <p className="text-xs text-slate-500">Recent documents submitted for automated registry population</p>
          </div>
        </CardHeader>
          ...
          {jobs.map((job) => (
            <div key={job.id} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100">{job.documentTitle}</h4>
