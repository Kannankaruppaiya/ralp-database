...
export default function GlobalLoading() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-slate-900/90 backdrop-blur-md text-white select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-teal-500/20 rounded-full blur-3xl pointer-events-none animate-pulse" />
      ...
      <div className="relative z-10 flex flex-col items-center max-w-sm w-full mx-4 p-8 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-2xl backdrop-blur-xl text-center">
        ...
        <div className="relative flex items-center justify-center w-20 h-20 mb-6">
          <div className="absolute inset-0 rounded-full border-2 border-teal-500/30 animate-ping opacity-75" />
          ...
          <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-teal-600 to-blue-600 flex items-center justify-center shadow-lg shadow-teal-900/40">
        ...
        <div className="w-full bg-slate-700/60 rounded-full h-1.5 mt-6 overflow-hidden relative">
          <div className="h-full bg-gradient-to-r from-teal-400 via-emerald-400 to-blue-500 rounded-full w-full animate-pulse" />
        </div>
