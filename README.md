...
- [ADR-001: In-Memory Caching & Performance Layer](docs/decisions/ADR-001-In-Memory-Caching-And-Performance.md)
- [ADR-002: Caldicott Principle 7 Immutable Audit Trail](docs/decisions/ADR-002-Caldicott-Principle-7-Audit-Trail.md)
- [ADR-003: Synthetic Clinical Cohort Generator & Benchmark Engine](docs/decisions/ADR-003-Synthetic-Clinical-Cohort-Benchmarking.md)
- [Client Specification & End-to-End Flow Guide](docs/CLIENT_SPECIFICATION_AND_FLOW_GUIDE.md)
